...
public class Hex : MonoBehaviour
{
    ...
    {
        if (_movementRestriction == MovementType.Passable)
            return _movementRequirement * GetTerrainDifficulty(_movementModifer);
        //returns a high value so nothing can ever move into the tile
        return 1000;
    }
    ...
    public void AddInfluence(int faction)
    {
        _factionInfluence[faction] = true;
    }

    public void RemoveInfluence(int faction)
    {
        _factionInfluence[faction] = false;
    }
}
