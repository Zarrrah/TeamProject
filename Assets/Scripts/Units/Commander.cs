...
public class Commander : MonoBehaviour, iUnit {

    private string _name = "Commander";

    private int _movement = 4;
    private int _health = 5;
    private int _rangedSkill = 5;
    private int _combarSkill = 5;
    private int _armourSkill = 7;
