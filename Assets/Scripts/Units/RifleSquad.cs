...
public class RifleSquad : MonoBehaviour, iUnit {

    private string _name = "Rifle Squad";

    private int _movement = 2;
    private int _health = 10;
    private int _rangedSkill = 10;
    private int _combarSkill = 15;
    private int _armourSkill = 12;
